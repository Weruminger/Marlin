...
#define MAGNETIC_PARKING_EXTRUDER
  ...
  #define PARKING_EXTRUDER_PARKING_X { PARKING_EXTRUDER_GRAB_DISTANCE, 140 }     // X positions for parking the extruders. M951 L{X_Pos_Left} R{X_Pos_Right}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 77
