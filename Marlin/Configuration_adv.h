...
#define FWRETRACT
  ...
  #define RETRACT_ZRAISE 0.6                // (mm) Default retract Z-raise
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     75  // [mm/s]
  #define X2_HYBRID_THRESHOLD    75
  #define Y_HYBRID_THRESHOLD     75
  #define Y2_HYBRID_THRESHOLD    75
